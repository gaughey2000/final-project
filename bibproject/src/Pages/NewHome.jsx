  ...
  return (
    ...
    <>
        <div className="w-full h-full flex flex-col items-center justify-center">
            ...
            {/*main section*/}
            <div className="w-250 h-1/2 relative flex flex-col items-center justify-center bg-tertiary rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 m-10" >
